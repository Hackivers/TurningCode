...
<div class="neo-card neo-card-light" style="margin-top: 32px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 24px; padding: 24px 32px;">
    <div>
        <h4 style="margin: 0 0 4px 0; font-size: 20px; font-weight: 700; color: #121212; display: flex; align-items: center; gap: 8px;">
            <i class='bx bx-timer' style="font-size: 24px; color: #888;"></i> Season Akan Berakhir
        </h4>
        <p style="margin: 0; font-size: 14px; color: #666;">Persiapkan dirimu. Peringkat dan EXP akan direset untuk musim baru.</p>
    </div>
    
    <div id="season-countdown" style="display: flex; gap: 16px; text-align: center;" data-target="{{ $nextSeason->toIso8601String() }}">
