...
@if ($hasProgress && $activeMateri->count())
    @foreach ($activeMateri as $main)
        <a href="?page=materi&main_id={{ $main->id }}" class="neo-card neo-card-light progres-card-wrapper"
            ...
            <div class="progres-img-wrapper" style="display: flex; justify-content: center; align-items: center; padding: 20px 0; flex: 1;">
    ...
    @if($activeMateri->count() == 1)
        ...
        <div class="neo-card neo-card-light progres-empty-wrapper" style="justify-content: center; align-items: center; opacity: 0.4;">
    ...
    @endif
@else
    <a href="?page=materi" class="neo-card neo-card-light progres-start-wrapper" style="min-height: 240px; grid-column: 1 / -1;">
        <div class="neo-header">
        ...
        <div>
            <p class="neo-desc progres-desc" style="font-weight: 500;">Pilih materi pertama yang ingin kamu pelajari hari ini di bawah.
            </p>
        </div>
    </a>
@endif
