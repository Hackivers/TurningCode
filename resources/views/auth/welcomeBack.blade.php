...
<head>
    ...
    <meta name="description" content="TurningCode — Platform pembelajaran interaktif. Akses materi, kerjakan tugas, dan pantau progresmu dalam satu tempat.">
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    @vite(['resources/css/global.css', 'resources/css/welcome.css'])
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@300;400;500;600;700&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        ...
        <header class="wlc-header">
            <div class="wlc-header-inner">
                ...
                <nav class="wlc-header-nav">
                    <a href="#" class="wlc-header-link" onclick="event.preventDefault(); showInfoPopup('Jelajahi berbagai modul pembelajaran terstruktur mulai dari dasar hingga mahir.')">Materi <i class='bx bx-chevron-down'></i></a>
                    <a href="#" class="wlc-header-link" onclick="event.preventDefault(); showInfoPopup('Nikmati fitur Live Code, Gamifikasi, hingga asisten AI TurnBot.')">Fitur <i class='bx bx-chevron-down'></i></a>
                    <a href="#" class="wlc-header-link" onclick="event.preventDefault(); showInfoPopup('TurningCode terintegrasi dengan Live DOM dan JS runtime execution di browser.')">Integrasi <i class='bx bx-chevron-down'></i></a>
                    <a href="#" class="wlc-header-link" onclick="event.preventDefault(); showInfoPopup('Temukan leaderboard komunitas, easter eggs, dan kejutan lainnya di dalam.')">Lainnya <i class='bx bx-chevron-down'></i></a>
                </nav>
                ...
                <button class="wlc-header-burger" onclick="document.querySelector('.wlc-header').classList.toggle('open')">
                    <i class='bx bx-menu'></i>
                </button>
            </div>

            <div class="wlc-header-mobile">
                <a href="#" class="wlc-mobile-link" onclick="event.preventDefault(); showInfoPopup('Jelajahi berbagai modul pembelajaran terstruktur mulai dari dasar hingga mahir.')">Materi</a>
                <a href="#" class="wlc-mobile-link" onclick="event.preventDefault(); showInfoPopup('Nikmati fitur Live Code, Gamifikasi, hingga asisten AI TurnBot.')">Fitur</a>
                <a href="#" class="wlc-mobile-link" onclick="event.preventDefault(); showInfoPopup('TurningCode terintegrasi dengan Live DOM dan JS runtime execution di browser.')">Integrasi</a>
                <a href="#" class="wlc-mobile-link" onclick="event.preventDefault(); showInfoPopup('Temukan leaderboard komunitas, easter eggs, dan kejutan lainnya di dalam.')">Lainnya</a>
                        ...
                        <div class="wlc-mockup-inner">
                            <div class="wlc-mockup-bar">
                                ...
                                <div class="wlc-mockup-url">
                                    <i class='bx bx-lock-alt' style="margin-right:6px;font-size:11px;"></i> turningcode.app
                                </div>
                                <div class="wlc-mockup-actions">
                                    <i class='bx bx-chevron-left'></i><i class='bx bx-chevron-right'></i><i class='bx bx-refresh'></i>
                                </div>
                            </div>
                            <div class="wlc-mockup-body">
                                <div class="wlc-mockup-sidebar">
                                    <div class="wlc-mock-logo"><i class='bx bx-code-alt'></i></div>
                                    <div class="wlc-mock-sidebar-item active"><i class='bx bx-home'></i> Dashboard</div>
                                    <div class="wlc-mock-sidebar-item"><i class='bx bx-book-open'></i> Materi</div>
                                    <div class="wlc-mock-sidebar-item"><i class='bx bx-task'></i> Tugas</div>
                                    <div class="wlc-mock-sidebar-item"><i class='bx bx-bar-chart-alt-2'></i> Progres</div>
                                    <div class="wlc-mock-sidebar-item"><i class='bx bx-cog'></i> Pengaturan</div>
                                </div>
                                <div class="wlc-mockup-main">
                                    <div class="wlc-mock-main-header">
                                        <div class="wlc-mock-greeting"><i class='bx bx-sun'></i><span>Selamat Pagi!</span></div>
        ...
        <section class="wlc-feature">
            <div class="wlc-feat-card">
                ...
                <div class="wlc-feat-left">
                    ...
                    <p class="feat-desc">
                        TurningCode menyediakan environment belajar yang terintegrasi. Tidak perlu instalasi — cukup buka materi, tulis kodemu, dan langsung jalankan.
                    </p>
                    
                    <div class="feat-quote">
                        <i class='bx bxs-quote-alt-left quote-icon'></i>
                        <p class="quote-text">
                            Dengan fitur live coding, pemahaman konsep menjadi jauh lebih cepat. Saya bisa langsung mempraktikkan teori yang baru saja dibaca tanpa pindah aplikasi.
                        </p>
                ...
                <div class="wlc-feat-right">
                    <div class="wlc-editor">
                        <div class="wlc-editor-header">
                            <div class="editor-tab active" data-tab="js" style="cursor:pointer;"><i class='bx bxl-javascript' style="color:#fbbf24"></i> script.js</div>
                            <div class="editor-tab" data-tab="html" style="cursor:pointer;"><i class='bx bxl-html5' style="color:#e34f26"></i> index.html</div>
                        </div>
                        <div class="wlc-editor-body">
                            <pre id="wlc-tab-js" class="wlc-code-tab" contenteditable="true" spellcheck="false" style="outline:none; display:block;"><code><span class="kwd">function</span> <span class="func">greet</span>(<span class="arg">name</span>) {
...
<span class="func">console</span>.<span class="func">log</span>(<span class="var">message</span>);</code></pre>
                            <pre id="wlc-tab-html" class="wlc-code-tab" contenteditable="true" spellcheck="false" style="outline:none; display:none;"><code>&lt;<span class="kwd">h3</span> <span class="arg">style</span>=<span class="str">"color: #fbbf24; margin: 0 0 10px;"</span>&gt;Halo Dunia!&lt;/<span class="kwd">h3</span>&gt;
&lt;<span class="kwd">p</span> <span class="arg">style</span>=<span class="str">"color: #a6e3a1; font-family: sans-serif; margin: 0;"</span>&gt;Coba ubah teks HTML ini dan klik Run.&lt;/<span class="kwd">p</span>&gt;</code></pre>
                        ...
                        <div class="wlc-editor-footer">
                            ...
                            <button class="editor-btn run-wlc-code">Run Code <i class='bx bx-right-arrow-alt'></i></button>
                        </div>
                        <div class="wlc-editor-output" style="display:none; border-top:1px solid rgba(255,255,255,0.05); padding:16px; background:#121212;">
                            <div class="wlc-output-header" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                                <span style="font-size:11px; font-weight:700; color:#888; text-transform:uppercase; letter-spacing:0.5px;">Live Output</span>
                                <button class="wlc-close-output" style="background:none; border:none; color:#888; cursor:pointer;"><i class='bx bx-x'></i></button>
                            </div>
                            <pre class="wlc-output-console" style="display:none; color:#a6e3a1; font-family:monospace; margin:0; font-size:13px; white-space:pre-wrap;"></pre>
                            <iframe class="wlc-output-frame" style="display:none; width:100%; height:120px; border:1px dashed rgba(255,255,255,0.2); border-radius:8px; background:transparent;"></iframe>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="wlc-roadmap">
            <div class="wlc-rm-header">
                ...
                <p class="rm-desc">Langkah demi langkah terstruktur untuk menguasai pemrograman dari nol hingga mahir.</p>
                ...
                <div class="rm-tabs">
                    ...
                    @foreach($mainMateris as $index => $main)
                        <button class="rm-tab-btn {{ $index == 0 ? 'active' : '' }}" data-target="rm-canvas-{{ $main->id }}">
                            {{ $main->title }}
                        </button>
                    @endforeach
                </div>
                                                ...
                                                <div class="rm-node">
                                                    ...
                                                    <div class="rm-node-body">
                                                        <div class="rm-row bg">
                                                            ...
                                                            <span class="rm-val">{{ \App\Models\SubMateri::where('materi_id', $materi->id)->count() }} Topik</span>
                                                        </div>
                                                        <div class="rm-row" style="display:block; padding: 12px 16px;">
                                                            <div class="rm-val" style="font-size: 11px; font-weight: normal; line-height: 1.5; color: #666; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; white-space: normal;">
        ...
        <section class="wlc-tiers">
            <div class="wlc-tiers-inner">
                <div class="wlc-tiers-header">
                    ...
                    <p class="tier-desc">TurningCode mengadaptasi sistem gamifikasi ala game RPG. Setiap kali kamu menyelesaikan materi atau tugas, kamu akan mendapatkan EXP untuk naik Rank/Tier. Berikut adalah 3 Tier paling elit yang bisa kamu capai:</p>
                </div>
        ...
        <section class="wlc-bot">
            <div class="wlc-bot-inner">
                <div class="wlc-bot-content">
                    ...
                    <p class="bot-desc">Asisten virtual cerdas yang siap menemani perjalanan belajarmu. TurnBot tidak hanya membantu menjawab pertanyaan seputar materi, tapi juga bisa menemanimu bermain mini-games, melacak mood belajarmu, dan memastikan kamu tetap termotivasi setiap hari!</p>
